...
} VocBlockType; //parasoft-suppress MISRA2008-2_10_1

typedef struct voc_voice_data{ //parasoft-suppress MISRA2008-2_10_1
	u_char tc;
	u_char pack;
} VocVoiceData;//parasoft-suppress MISRA2008-2_10_1
